...
const supportActions: SupportAction[] = [
  {
    ...
    description:
      'Déclarez un problème de livraison, paiement ou qualité en moins de 2 minutes.',
    icon: FileText,
  ...
  },
  {
    ...
    description:
      'Consultez l’état de vos dossiers, les échanges récents et les prochaines étapes.',
    icon: Search,
    cta: 'Voir le suivi',
  ...
  },
  {
    ...
    description:
      'Un conseiller disponible 7j/7 via chat, téléphone ou WhatsApp Business.',
    icon: Headset,
...
> = {
  ...
  analysis: {
    ...
    description:
      'Nos équipes vérifient la commande et contactent les intervenants.',
  },
  escalated: {
    label: 'Escaladé Niveau 2',
    badgeClass: 'bg-purple-100 text-purple-700',
    description:
      'Le dossier est traité conjointement avec le support technique.',
  },
  waiting_customer: {
    label: 'En attente client',
    badgeClass: 'bg-amber-100 text-amber-700',
    description:
      'Nous avons besoin d’informations complémentaires pour avancer.',
  },
  resolved: {
    label: 'Résolu',
...
const chatbotSample: ChatMessage[] = [
  {
    ...
    timestamp: '09:02',
    content:
      'Bonjour 👋 Je suis KingBot. Quel service souhaitez-vous pour votre commande #CMD-98432 ?',
  },
  {
    sender: 'user',
    timestamp: '09:03',
    content:
      'Il manque toujours ma boisson. Pouvez-vous me confirmer l’envoi ?',
  },
  {
    sender: 'bot',
    timestamp: '09:03',
  ...
  },
  {
    ...
    timestamp: '09:04',
    content:
      'Le livreur reprogrammé arrive dans 20 minutes avec la boisson manquante. Souhaitez-vous qu’un agent humain confirme par téléphone ?',
  },
  {
    sender: 'user',
    timestamp: '09:04',
...
const faqItems = [
  {
    question:
      'Quels documents dois-je fournir pour une réclamation livraison ?',
    answer:
            ...
            <div className="grid gap-10 lg:grid-cols-[1.2fr,1fr]">
              <div className="space-y-6">
                ...
                <p className="text-lg text-gray-600 md:text-xl">
                  Notre cellule Support & Satisfaction est disponible 7j/7 pour
                  suivre vos commandes, traiter vos réclamations et vous
                  accompagner comme un partenaire privilégié.
                </p>
                ...
                <div className="relative overflow-hidden rounded-[28px] border border-red-100 bg-white p-8 shadow-2xl">
                  ...
                  <div className="mt-8 rounded-2xl border border-red-100 bg-gradient-to-br from-white via-red-50 to-white px-5 py-4 text-sm">
                    <p className="font-semibold text-gray-900">
                      Assistance prioritaire Club Royal
                    </p>
                    <p className="mt-1 text-gray-600">
                      Vos réclamations sont traitées avant 2h, avec compensation
                      fidélité immédiate.
                    </p>
                  </div>
                </div>
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            {supportActions.map(action => {
              ...
              return (
                <Card
                  key={action.title}
                  className="border-red-100 shadow-sm transition-shadow hover:shadow-lg"
                >
            ...
            <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
              <div>
                ...
                <p className="mt-3 max-w-2xl text-gray-600">
                  Gardez une vision claire de vos dossiers : statut, propriété,
                  et prochaines actions. Nos équipes mettent à jour l’avancement
                  en temps réel, comme sur Amazon.
                </p>
              </div>
              <Button
                variant="outline"
                  ...
                  <Card key={claim.id} className="border-red-100 shadow-sm">
                    <CardHeader className="space-y-3">
                      <div className="flex items-center justify-between">
                        ...
                        <Badge
                          className={`${status.badgeClass} text-xs font-semibold`}
                        >
                          {status.label}
                        </Badge>
                      </div>
          ...
          <div className="grid gap-8 lg:grid-cols-[1.1fr,0.9fr]">
            <Card className="border-red-100 shadow-sm">
              <CardHeader className="space-y-3">
                ...
                <p className="text-sm text-gray-600">
                  KingBot vous assiste pour collecter toutes les informations
                  nécessaires et garantir une prise en charge immédiate.
                </p>
              </CardHeader>
              <CardContent className="space-y-4">
                {[
                  {
                    ...
                    description:
                      'Recherche automatique par numéro, QR code ou historique fidélité.',
                    icon: PackageCheck,
                  },
                  {
                    title: '2. Décrivez le problème en quelques mots',
                    description:
                      'Catégories pré-remplies (livraison, paiement, produit, promotion).',
                    icon: FileText,
                  },
                  {
                    title: '3. Joignez des preuves si nécessaire',
                    description:
                      'Ajoutez photos, reçu ou note vocale. Taille maximale : 25 Mo.',
                    icon: Link2,
                  },
                  {
                    title: '4. Choisissez le canal de résolution',
                    description:
                      'Chat en direct, rappel téléphonique, crédit fidélité ou remboursement.',
                    icon: PhoneCall,
                  },
                ].map(step => {
            ...
            <Card className="border-red-100 bg-gradient-to-br from-white via-red-50 to-orange-50 shadow-sm">
              <CardHeader className="space-y-3">
                <Badge className="bg-white text-red-600">
                  Chat intelligent + agent
                </Badge>
                <CardTitle className="text-2xl text-gray-900">
                  Parler à un agent
                </CardTitle>
                <p className="text-sm text-gray-600">
                  KingBot traite les étapes simples puis transfère à un
                  conseiller spécialisé selon votre besoin.
                </p>
              </CardHeader>
              <CardContent className="space-y-4">
                  ...
                  <div className="space-y-3">
                    {chatbotSample.map((message, index) => {
                      ...
                      return (
                        ...
                        >
                          <div
                            className={`flex h-10 w-10 items-center justify-center rounded-full ${isBot ? 'bg-red-50 text-red-500' : 'bg-slate-900 text-white'}`}
                          >
                            <Icon className="h-5 w-5" />
                          </div>
                          <div className="max-w-xs space-y-1">
                            <div
                              className={`rounded-2xl px-4 py-3 text-sm ${isBot ? 'bg-red-50 text-gray-700' : 'bg-slate-900 text-white'}`}
                            >
                              {message.content}
                            </div>
                ...
                <div className="rounded-xl border border-red-100 bg-white px-4 py-3 text-sm text-gray-600">
                  ...
                  <p className="mt-1">
                    Après 5 minutes sans solution, l’agent humain reprend la
                    main avec un résumé complet du bot.
                  </p>
                </div>
        ...
        <section className="border-t border-red-100 bg-gradient-to-b from-white to-red-50 py-16">
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-2xl text-center">
              <h2 className="text-3xl font-bold text-gray-900 md:text-4xl">
                FAQ support & satisfaction
              </h2>
              <p className="mt-3 text-gray-600">
                Les réponses aux questions les plus fréquentes, inspirées des
                standards Amazon.
              </p>
            </div>
