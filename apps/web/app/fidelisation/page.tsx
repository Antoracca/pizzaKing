...
const earningMoments = [
  {
    ...
    description:
      '1 point de base pour chaque 500 FCFA dépensés sur le site ou l’app.',
    icon: Pizza,
  },
  {
    title: 'Objectifs hebdomadaires',
    description:
      'Bonus +25 pts quand vos trois commandes de la semaine dépassent 10 000 FCFA.',
    icon: Zap,
  },
  {
    title: 'Parrainage d’amis',
    description:
      '75 points pour vous et 75 points pour votre filleul à sa première commande.',
    icon: Gift,
  },
  {
    title: 'Moments VIP',
    description:
      'Doublement des points pendant les soirées match et événements spéciaux.',
    icon: Ticket,
  },
];
...
const faqItems = [
  {
    ...
    answer:
      'Les points restent actifs 12 mois après la dernière commande. Passez simplement une commande pour les prolonger.',
  },
  {
    question: 'Comment profiter de mes récompenses ?',
    answer:
      'Depuis votre espace compte, sélectionnez la récompense disponible avant de valider votre panier.',
  },
  {
    question: 'Puis-je combiner offres et points ?',
    answer:
      'Oui, les promotions en cours sont cumulables avec les réductions liées à votre palier.',
  },
];
          ...
          <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-600 md:text-xl">
                Notre programme transforme chaque commande en avantages
                exclusifs : réductions, cadeaux, livraison premium et
                expériences VIP.
              </p>
              ...
              <div className="flex items-center gap-4 rounded-2xl border border-red-100 bg-white/60 px-6 py-4 shadow-sm backdrop-blur">
                ...
                <div>
                  <p className="text-sm font-semibold text-gray-900">
                    Livraison prioritaire dès le palier Argent
                  </p>
                  <p className="text-sm text-gray-600">
                    Des délais réduits garantis aux membres premium.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-2xl text-center">
              <h2 className="text-3xl font-bold text-gray-900 md:text-4xl">
                Quatre paliers motivants
              </h2>
              <p className="mt-4 text-lg text-gray-600">
                Chaque niveau débloque des avantages supplémentaires et augmente
                la vitesse d’accumulation des points.
              </p>
            </div>
            ...
            <div className="mt-12 grid gap-6 lg:grid-cols-4">
              {tierOrder.map(tier => {
                ...
                const nextThreshold = tierOrder.find(
                  candidate =>
                    LOYALTY_TIER_THRESHOLDS[candidate] >
                    LOYALTY_TIER_THRESHOLDS[tier]
                );

                return (
                  <Card
                    key={tier}
                    className="relative overflow-hidden border-red-100"
                  >
                    <div
                      className={`absolute inset-x-0 top-0 h-2 bg-gradient-to-r ${tierGradients[tier]}`}
                    />
          ...
          <div className="grid gap-10 lg:grid-cols-[1fr,1.2fr] lg:items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-600">
                Chaque interaction avec Pizza King vous rapproche d’une
                récompense. Combinez les moments de gain pour accélérer votre
                progression.
              </p>
              <div className="space-y-4">
                {earningMoments.map(moment => (
                  <div
                    key={moment.title}
                    className="flex gap-4 rounded-2xl border border-red-100 bg-white px-5 py-4 shadow-sm"
                  >
                    <div className="flex h-12 w-12 items-center justify-center rounded-full bg-red-50 text-red-500">
            ...
            <Card className="border-red-100 bg-white/80 shadow-lg shadow-red-100">
              <CardHeader>
                ...
                <CardTitle className="text-2xl text-gray-900">
                  Gains cumulés sur un mois
                </CardTitle>
                <p className="text-sm text-gray-600">
                  Avec quatre commandes familiales et un événement spécial, un
                  membre Platine peut générer plus de 1 200 points en 30 jours.
                </p>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div className="grid gap-3">
                  {[
                    ...
                    {
                      label: 'Objectif hebdomadaire débloqué',
                      value: '+100 pts',
                    },
                    ...
                    <div
                      key={item.label}
                      className="flex items-center justify-between rounded-lg bg-white px-4 py-3 text-sm text-gray-700"
                    >
                ...
                <div className="rounded-xl bg-red-500/10 px-5 py-4 text-center">
                  ...
                  <p className="mt-2 text-xs text-gray-600">
                    Suffisant pour un menu XL offert ou deux livraisons
                    gratuites.
                  </p>
                </div>
              </CardContent>
        ...
        <section className="border-t border-red-100 bg-gradient-to-b from-white to-red-50 py-16">
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-4 text-lg text-gray-600">
                Nous simplifions le programme pour que vous profitiez de vos
                avantages sans effort.
              </p>
            </div>
            ...
            <div className="mx-auto mt-12 max-w-2xl rounded-3xl border border-red-100 bg-white px-8 py-10 text-center shadow-md">
              ...
              <p className="mt-2 text-sm text-gray-600">
                Contactez le Service Royals pour planifier vos commandes
                entreprises et événements privés.
              </p>
              <Button
                variant="outline"
